...
List<Stories> storiesFromJson(String str) => new List<Stories>.from(json.decode(str).map((x) => Stories.fromJson(x)));

String storiesToJson(List<Stories> data) => json.encode(new List<dynamic>.from(data.map((x) => x.toJson())));
...
class Stories {
    ...
    factory Stories.fromJson(Map<String, dynamic> json) => new Stories(
        userId: json["userId"],
