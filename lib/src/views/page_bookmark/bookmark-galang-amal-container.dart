...
class BookmarkGalangAmalContainer extends StatefulWidget {
  final ListProgram programAmal;
  final bool likes;

  BookmarkGalangAmalContainer({Key key, this.programAmal, this.likes});

  @override
  _BookmarkGalangAmalContainerState createState() => _BookmarkGalangAmalContainerState(likes: this.likes);
}

class _BookmarkGalangAmalContainerState extends State<BookmarkGalangAmalContainer> {

  bool likes;
  _BookmarkGalangAmalContainerState({this.likes});
