...
class BookmarkKomentarBerita extends StatefulWidget {
  final ListBerita berita;

  BookmarkKomentarBerita({Key key, @required this.berita}) : super(key: key);
  @override
  _BookmarkKomentarBeritaState createState() => _BookmarkKomentarBeritaState();
}

class _BookmarkKomentarBeritaState extends State<BookmarkKomentarBerita> with SingleTickerProviderStateMixin {
