...
class BookmarkGalangAmalDetails extends StatefulWidget {
  final ListProgram programAmal;
  final bool likes;
  BookmarkGalangAmalDetails({Key key, this.programAmal, this.likes});

  @override
  _GalangAmalState createState() => _GalangAmalState(likes: this.likes);
}

class _GalangAmalState extends State<BookmarkGalangAmalDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          BookmarkProgramAmalContent(programAmal: widget.programAmal, likes: likes, bookmark: widget.programAmal.bookmarkThis),
        ],
      ),
