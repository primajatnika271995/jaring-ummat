...
import 'package:flutter_jaring_ummat/src/views/page_bookmark/bookmark-berita-komentar.dart';
...
class BookmarkBeritaDetails extends StatefulWidget {
  final ListBerita value;

  BookmarkBeritaDetails({this.value});

  @override
  _BookmarkBeritaDetailsState createState() => _BookmarkBeritaDetailsState();
}

class _BookmarkBeritaDetailsState extends State<BookmarkBeritaDetails> {
  final String noImg =
