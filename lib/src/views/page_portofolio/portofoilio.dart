        ...
        series: <ColumnSeries<SalesData, String>>[
          ColumnSeries(
            dataSource: <SalesData>[
              ...
              SalesData('', snapshot[1].total.toDouble()),
              SalesData(' ', snapshot[2].total.toDouble()),
              SalesData('  ', snapshot[3].total.toDouble()),
              SalesData('   ', snapshot[4].total.toDouble()),
              SalesData('    ', snapshot[5].total.toDouble()),
              SalesData('     ', snapshot[6].total.toDouble()),
              SalesData('      ', snapshot[7].total.toDouble()),
              SalesData('       ', snapshot[8].total.toDouble()),
              SalesData('        ', snapshot[9].total.toDouble()),
              SalesData('         ', snapshot[10].total.toDouble()),
