...
class _MenuState extends State<Menu> {
  ...
  // Variable Store Email for get User Details Params
  String _email;
...
//    userDetailsService.userDetails(_email).then((Response response) {
//      print(response.data[0]);
//      UserDetails userDetails = new UserDetails.fromJson(response.data[0]);
//      setState(() {
//
//      });
//    });
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: new Container(
          child: new FutureBuilder<UserDetails>(
              future: fetchUserDetails(_email),
                                    ...
                                    new Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          new Text(
                                            "${snapshot.data.email} - ${snapshot.data.contact}",
                                            style: TextStyle(
