...
class SearchProgramAmal extends StatefulWidget {
  @override
  _SearchProgramAmalState createState() => _SearchProgramAmalState();
}

class _SearchProgramAmalState extends State<SearchProgramAmal> {
